...
public class ConversationActivity extends BaseActivity implements View.OnClickListener {
    ...
    private SparseArray<List<ChatMessage>> allMessages=new SparseArray<>();
    public MessageAdapter getAdapter() {
        return adapter;
    }
    public SparseArray<List<ChatMessage>> getAllMessages() {
        return allMessages;
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        messagelistview = findViewById(R.id.conversation_listview);
        init();
    }
    ...
    public void init() {
        ...
        if(bundle==null){
            Toast.makeText(this,"没有传入数据",Toast.LENGTH_SHORT).show();
            finish();
        }else{
